...
{
	/// <summary>
	/// GUI for configuring Insert Nodes - using Jötunn GUIManager
	/// </summary>
	public class InsertNodeGUI : BaseNodeGUI
	{
		...
		private void BuildUI()
		{
			...
			CreateSpacer(content.transform, 5);
			CreateSecondRow(content.transform);
		...
		private void CreateTitle(Transform parent)
		{
			Text title = CreateJotunnText(
				parent: parent,
				text: "Insert Node Configuration",
				fontSize: 20,
		...
		{
			GameObject firstRow = CreateHorizontalGroup(parent, spacing: 10, height: 50, alignment: TextAnchor.MiddleLeft);

			// Channel label
			CreateJotunnText(
				parent: firstRow.transform,
				text: "Channel ID:",
				fontSize: 16,
			...
			spacer.transform.SetParent(firstRow.transform, false);
			...
			// Priority input
			priorityInput = CreateJotunnInputField(
				parent: firstRow.transform,
				placeholder: "0",
				width: 100,
				height: 30
		...
		private void CreateSecondRow(Transform parent)
		{
			GameObject secondRow = CreateHorizontalGroup(parent, spacing: 10, height: 50, alignment: TextAnchor.MiddleLeft);

			// Whitelist toggle
			whitelistToggle = CreateJotunnToggle(
				parent: secondRow.transform,
			...
			// Add flexible space
			GameObject spacer = new GameObject("Spacer");
			spacer.transform.SetParent(secondRow.transform, false);
			LayoutElement spacerElem = spacer.AddComponent<LayoutElement>();
